      ...
      <div class="container-fluid">
        <div class="shipping-address">
                        ...
                        <div class="a-row a-spacing-base" v-for="product in getCart" :key="product._id">
                          <div class="row">
                            ...
                            <div class="col-sm-9 col-9">
                              ...
                              <div class="a-row a-color-secondary a-size-small">Sold by:&nbsp;EthadZone.com Services, Inc
                              </div>
                              <div class="a-row">
                ...
                <div class="a-box a-first">
                  <div class="a-box-inner">
                    ...
                    <div class="a-row a-spacing-small a-size-small a-text-center">
                      By placing your order, you agree to EthadZone's
                      ...
                      <div id="tfx-header">
                        <div class="a-box a-alert-info a-spacing-small">
                          <div class="a-box-inner alert-info-no-icon">
                            <strong>
                              EthadZone Currency Converter is Enabled. &nbsp;
          ...
          <div class="a-row a-spacing-small a-spacing-top-small">
            ...
            <p class="a-color-secondary a-size-mini">
              For an item sold by EthadZone.com: When you click the "Place your order" button, we'll send you an email
              message
              acknowledging receipt of your order. Your contract to purchase an item will not be complete until we send
              you
              an email notifying you that the item has been shipped.
            </p>
            ...
            <div class="a-color-secondary a-size-mini">
              <p class="a-color-secondary a-size-mini">
                ...
                and restrictions apply. See EthadZone.com's
                <a href="#">Returns Policy</a>
                <br />
                <br />Go to the
                <a href="#">EthadZone.com homepage</a> without completing your order.
              </p>
            </div>
          </div>
          <hr />
          <p class="a-size-small a-text-center a-color-secondary" data-testid>
            <a href="#">Conditions of Use</a> |
            <a href="#">Privacy Notice</a> © 1996-2021, EthadZone.com, Inc.
          </p>
        </div>
      </div>
      <!--/SHIPPING ADDRESS-->
