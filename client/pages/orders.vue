            ...
            <div v-for="product in order.products" :key="product._id">
              ...
              <div class="row">
                ...
                <div class="col-xl-10 col-lg-10 col-10">
                  ...
                  <div class="a-row">
                    <span class="a-size-mini a-color-secondary">Sold by: EthadZone Export Sales LLC</span>
                  </div>
                  <div class="a-row">
                    <!-- Product quantity -->
                  ...
                  <br />
                  <div class="a-row">
                    <nuxt-link to='/placeorder' class="a-button-buy-again">Buy it again</nuxt-link>
                    <label class="a-button-view-item">View your item</label>
                  </div>
                </div>
              </div>
            </div>
